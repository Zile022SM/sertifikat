...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Unesi kurs</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo URLROOT;?>/kursevi/insert" method="post" enctype="multipart/form-data">
                                        ...
                                        <br>
                                        <button type="submit" name="click" value="Save" class="btn btn-success">Snimi kurs</button>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
