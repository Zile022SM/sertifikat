...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Izmeni polaznika</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo URLROOT;?>/polaznici/edit" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="broj" value="<?php echo isset($data["broj_telefona"]) ? htmlspecialchars($data["broj_telefona"]) : "";?>" class="form-control" placeholder="Unesi broj">
                                            <?php 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="datepicker" type="text" name="datum" value="<?php echo isset($data["datum_rodjenja"]) ? htmlspecialchars($data["datum_rodjenja"]) : "";?>" class="form-control" placeholder="Unesi datum">
                                            <?php 
                                        ...
                                        <br>
                                        <button type="submit" name="click" value="Edit" class="btn btn-success">Izmeni polaznika</button>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
