...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Izmeni profesora</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <p style="color:red;margin-left:20px;font-size:24px;"><b><?php echo isset($data["status"]) ? htmlspecialchars($data["status"]) : "";?></b></p>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo URLROOT;?>/profesori/edit" method="post" enctype="multipart/form-data">
	                                        ...
	                                        <?php
						                        if(isset($data['slika']) && !empty($data['slika'])){
						                            ?>
						                                ...
						                                <img style="width: 180px; height: auto;" src="<?php echo URLROOT.'/img/profesori/'.$data['slika'];?>">
						                            <?php
						                        }
						                    ?>
                                            <br><br>
                                        ...
                                        <input type="hidden" name="profaslika" value="<?php echo isset($data['slika']) ? htmlspecialchars($data['slika']) : "";?>">
                                        <input type="hidden" name="id" value="<?php echo isset($data['id']) ? htmlspecialchars($data['id']) : "";?>">
                                        <br>
                                        <button type="submit" name="click" value="Edit" class="btn btn-success">Edit profesora</button>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
